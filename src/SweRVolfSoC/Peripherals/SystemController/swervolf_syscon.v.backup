...
`endif
	...
	// Eight-Digit 7 Segment Displays
	  ...
	  SevSegDisplays_Controller SegDispl_Ctr(
	    .clk               (i_clk),    
	    .rst_n             (i_rst),
	    .Enables_Reg       ({Digits_Reg[63], Digits_Reg[55], Digits_Reg[47], Digits_Reg[39], Digits_Reg[31], Digits_Reg[23], Digits_Reg[15], Digits_Reg[7]}), 
...
module SevSegDisplays_Controller(
  ...
  assign digits_concat[0] = Digits_Reg[6:0];
  assign digits_concat[1] = Digits_Reg[14:8];
  assign digits_concat[2] = Digits_Reg[22:16];
  assign digits_concat[3] = Digits_Reg[30:24];
  assign digits_concat[4] = Digits_Reg[38:32];
  assign digits_concat[5] = Digits_Reg[46:40];
  assign digits_concat[6] = Digits_Reg[54:48];
  assign digits_concat[7] = Digits_Reg[62:56];
...
module SevenSegDecoder(input wire     [6:0] data,
  ...
  always @(*)
    case(data)
                  // abc_defg
      7'd0 : seg = 7'b000_0001; //0 -
      7'd1 : seg = 7'b100_1111; //1 -
      7'd2 : seg = 7'b001_0010; //2 -
      7'd3 : seg = 7'b000_0110; //3 -
      7'd4 : seg = 7'b100_1100; //4 -
      7'd5 : seg = 7'b010_0100; //5 - 
      7'd6 : seg = 7'b010_0000; //6 -
      7'd7 : seg = 7'b000_1111; //7 -
      7'd8 : seg = 7'b000_0000; //8 -
      7'd9 : seg = 7'b000_1100; //9 -
      7'd10: seg = 7'b000_1000; //A -
      7'd11: seg = 7'b110_0000; //B -
      7'd12: seg = 7'b011_0001; //C -
      7'd13: seg = 7'b100_0010; //D -
      7'd14: seg = 7'b011_0000; //E -
      7'd15: seg = 7'b011_1000; //F -
      7'd16: seg = 7'b000_0100; //G -
      7'd17: seg = 7'b110_1000; //H -
      7'd18: seg = 7'b110_1111; //I -
      7'd19: seg = 7'b100_0011; //J -
      7'd20: seg = 7'b111_1000; //K -
      7'd21: seg = 7'b111_0001; //L -
      7'd22: seg = 7'b100_1010; //M -
      7'd23: seg = 7'b110_1010; //N -
      7'd24: seg = 7'b110_0010; //O -
      7'd25: seg = 7'b001_1000; //P -
      7'd26: seg = 7'b001_0000; //Q -
      7'd27: seg = 7'b111_1010; //R -
      7'd28: seg = 7'b011_0100; //S -
      7'd29: seg = 7'b111_0000; //T -
      7'd30: seg = 7'b110_0011; //U -
      7'd31: seg = 7'b100_0001; //V -
      7'd32: seg = 7'b100_0000; //W -
      7'd33: seg = 7'b100_1000; //X -
      7'd34: seg = 7'b100_0100; //Y -
      7'd35: seg = 7'b011_0010; //Z -
      default: 
            seg = data; //If not defined. You set pins yourself.
    endcase
endmodule
