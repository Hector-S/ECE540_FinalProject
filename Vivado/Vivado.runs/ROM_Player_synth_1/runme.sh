...
HD_PWD='D:/Users/Hector/Desktop/Winter_2023/ECE_540/Labs/FinalProject/Vivado/Vivado.runs/ROM_Player_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_Player.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_Player.tcl
