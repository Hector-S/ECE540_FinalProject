...
#
# Generated by export_simulation on Mon Feb 27 20:41:21 -0800 2023
#
################################################################################
...
'-reset_run' switch to the './clk_315.sh' script.

./clk_315.sh -reset_run
...
./clk_315.sh -noclean_files

For more information on the script, please type './clk_315.sh -help'.
