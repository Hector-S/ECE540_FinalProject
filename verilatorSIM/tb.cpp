...
int main(int argc, char **argv, char **env)
{
  ...
  while (!(done || Verilated::gotFinish())) {
    ...
    if(main_time == 30000 - 100) {
      top->i_pb = 1;
    }
    if(main_time == 30100 - 100) {
      top->i_pb = top->i_pb << 1;
    }
    if(main_time == 30200 - 100) {
      top->i_pb = top->i_pb << 1;
    }
    if(main_time == 30300 - 100) {
      top->i_pb = top->i_pb << 1;
    }
    if(main_time == 30400 - 100) {
      top->i_pb = top->i_pb << 1;
    }
    if(main_time == 30500 - 100) {
      top->i_pb = top->i_pb << 1;
    }
    if(main_time == 30600 - 100) {
      top->i_pb = 0;
    }
  }
